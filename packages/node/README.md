...
`rasterPage()` runs off the JavaScript thread and returns tightly packed
`rgb8` or `rgbx8` pixels. This example bounds memory to four active pages and
writes JPEGs directly to disk with Sharp:
