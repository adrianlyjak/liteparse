...
`raster_page()` returns tightly packed `rgb8` or `rgbx8` pixels, ready for
Pillow or another encoder. This example keeps only four page buffers in flight
and writes each JPEG directly to disk:
